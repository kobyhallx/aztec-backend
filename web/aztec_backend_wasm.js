...
function __wbg_adapter_26(arg0, arg1, arg2) {
    try {
        ...
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h009dc6428030c262(retptr, arg0, arg1, addBorrowedObject(arg2));
...
function __wbg_adapter_29(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h24879b0b75077c76(retptr, arg0, arg1, addBorrowedObject(arg2));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function compute_witnesses(circuit, initial_js_witness) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function serialise_acir_to_barrtenberg_circuit(acir) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function packed_witness_to_witness(acir, witness_arr) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
export function eth_contract_from_cs(vk_method) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function serialise_public_inputs(pub_inputs_js_string) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function getImports() {
    ...
    imports.wbg.__wbg_new_2c576172346480cc = function () {
    ...
    imports.wbg.__wbg_new_a6e81f54eecf7748 = function () {
        return handleError(function (arg0) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('aztec_backend_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
